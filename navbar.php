    ...
    <div class="d-inline-block"><span style="color: rgba(255,255,255,1);padding: 0px;"><strong>&nbsp;&nbsp;BRIMS</strong><br /><span style="color: rgba(255,255,255,1);padding: 0px;font-size:12px"><p>&nbsp;&nbsp;&nbsp;Barangay Records and Information Management System</p></span></span></div>
            ...
            <div class="collapse navbar-collapse" id="navcol-3">
                <ul class="navbar-nav mx-auto">
                    ...
                    <li class="nav-item" style="color: rgb(255,255,255);font-family: Roboto, sans-serif;"><a class="nav-link" href="loginfirst.php" style="color: rgb(255,255,255);font-family: Roboto, sans-serif;">REQUEST FORM</a></li>
                    ...
                    <li class="nav-item" style="color: rgb(255,255,255);font-family: Roboto, sans-serif;"><a class="nav-link" href="login.php" style="color: rgb(255,255,255);font-family: Roboto, sans-serif;">LOG IN</a></li>
