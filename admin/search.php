...
<body>
    ...
    <div>
        ...
        <div style="border-style: none;">
            <form method="POST" action="<?php htmlspecialchars($_SERVER["PHP_SELF"]); ?>" autocomplete="on" class="d-flex justify-content-center align-items-center search-form" style="border-style: none;">
                <div class="input-group" style="width: 720px;"><span class="input-group-text" style="font-family: Roboto, sans-serif;font-size: 34px;"><i class="fa fa-search"></i></span>
					<input class="form-control" type="text" placeholder="I am looking for.."  name="search" value="<?php echo $search; ?>"   style="font-family: Roboto, sans-serif;">
						<button class="btn btn-light" type="submit" style="background: rgb(254,142,23);color: rgb(255,255,255);font-family: Roboto, sans-serif;font-size: 23px;">SEARCH</button></div>
						&nbsp;&nbsp;&nbsp;<span style="font-size: 20px; color:red;"><?php echo $searchErr; ?></span>
            </form>
        </div>
    </div>
