...
<body>
    ...
    <div class="d-flex justify-content-center align-items-center"><img class="img-fluid d-flex justify-content-center align-items-center dohlogo" data-aos="zoom-in-up" data-aos-duration="1000" src="assets/img/doh.png"></div>
    <div>
        <div>
            <hr>
            <h2 class="text-center" style="color: rgb(0,153,51);font-size: 50px;font-family: Roboto, sans-serif;"><strong>DOH PROFILE</strong></h2>
            <p style="font-family: Roboto, sans-serif;text-align: center;font-size: 20px;margin: 14px;">The Department of Health (DOH) holds the over-all technical authority on health as it is a national health policy-maker and regulatory institution.</p>
            <p style="font-family: Roboto, sans-serif;text-align: justify;font-size: 20px;margin: 14px;">Basically, the DOH has three major roles in the health sector: <br>(1) leadership in health; <br>(2) enabler and capacity builder; and <br>(3) administrator of specific services. <br>Its mandate is to develop national plans, technical standards, and guidelines on health. Aside from being the regulator of all health services and products, the DOH is the provider of special tertiary health care services and technical assistance to health providers and stakeholders.</p>
            <p style="font-family: Roboto, sans-serif;text-align: justify;font-size: 20px;margin: 14px;">While pursuing its vision, the DOH adheres to the highest values of work, which are:</p>
        </div>
    </div>
    <ul>
        <li style="font-size: 20px;font-family: Roboto, sans-serif;color: #000000;"><strong>Integrity -&nbsp;</strong>The Department believes in upholding truth and pursuing honesty, accountability, and consistency in performing its functions.</li>
        <li style="font-size: 20px;font-family: Roboto, sans-serif;color: #000000;"><strong>Excellence –&nbsp;</strong>The DOH continuously strive for the best by fostering innovation, effectiveness and efficiency, pro-action, dynamism, and openness to change.</li>
        <li style="font-size: 20px;font-family: Roboto, sans-serif;color: #000000;"><strong>Compassion and respect for human dignity –&nbsp;</strong>Whilst DOH upholds the quality of life, respect for human dignity is encouraged by working with sympathy and benevolence for the people in need.</li>
        <li style="font-size: 20px;font-family: Roboto, sans-serif;color: #000000;"><strong>Commitment –&nbsp;</strong>With all our hearts and minds, the Department commits to achieve its vision for the health and development of future generations.</li>
        <li style="font-size: 20px;font-family: Roboto, sans-serif;color: #000000;"><strong>Professionalism –&nbsp;</strong>The DOH performs its functions in accordance with the highest ethical standards, principles of accountability, and full responsibility.</li>
        <li style="font-size: 20px;font-family: Roboto, sans-serif;color: #000000;"><strong>Teamwork –&nbsp;</strong>The DOH employees work together with a result-oriented mindset.</li>
        <li style="font-size: 20px;font-family: Roboto, sans-serif;color: #000000;"><strong>Stewardship of the health of the people –&nbsp;</strong>Being stewards of health for the people, the Department shall pursue sustainable development and care for the environment since it impinges on the health of the Filipinos.</li>
    </ul>
    <p style="font-family: Roboto, sans-serif;text-align: justify;font-size: 20px;margin: 14px;">Together with its attached agencies, the DOH – constituted of various central bureaus and services in the Central Office, Centers for Health Development (CHD) in every region, and DOH-retained hospitals – performs its roles to continuously improve the country’s health care system.</p>
    <hr>
    ...
    <p style="font-family: Roboto, sans-serif;text-align: justify;font-size: 20px;margin: 14px;"><strong>VISION -</strong> Filipinos are among the healthiest people in Southeast Asia by 2022, and Asia by 2040</p>
    <p style="font-family: Roboto, sans-serif;text-align: justify;font-size: 20px;margin: 14px;"><strong>MISSION -</strong> To lead the country in the development of a productive, resilient, equitable and people-centered health system</p>
    <div class="d-flex justify-content-center align-items-center"><img class="img-fluid d-flex justify-content-center align-items-center dohlogo" data-aos="flip-left" data-aos-duration="1000" src="assets/img/resbakuna.png"></div>
