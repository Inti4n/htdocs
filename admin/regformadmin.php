                ...
                <div class="form-group mb-3">
                    <div id="formdiv">
                        ...
                        <div class="row" style="margin-right:0px;margin-left:0px;padding-top:24px;">
                         ...
                         <div class="col-12 col-md-4 offset-md-4 d-flex align-items-center align-content-center" style="width: 252.646px;height: 77px;">
						 <a class="btn btn-light btn-lg" role="button" style="font-family: Roboto, sans-serif;background: #fe8e17;font-size: 14px;color: rgb(255,255,255);" href="firstdosepre.php">1ST DOSE</a>
						 <a class="btn btn-light btn-lg" role="button" style="margin-left: 16px;color: rgb(255,255,255);background: #fe8e17;font-size: 14px;" href="seconddosepre.php">2ND DOSE</a></div>
					   </div>
                    </div>
                </div>
            </form>
...
$view_query = mysqli_query($connections, "SELECT * FROM tbl_vacinfo ORDER BY id ASC ");
...
<tr>
	...
	<th>Relation to the vaccinee</th>
	<th>Contact Number</th>
	<th>Category</th>
	<th>Option</th>
...
while ($row = mysqli_fetch_assoc($view_query)) {
	...
	$db_email = $row["email"];
	$db_contactperson = $row["contactperson"];
	$db_relation = $row["relation"];
	$db_relcontactnumber = $row["relcontactnumber"];
	...
	<tr>
		...
		<td>$db_email</td>
		<td>$db_contactperson</td>
		<td>$db_relation</td>
		<td>$db_relcontactnumber</td>
		<td>$db_category</td>
		<td>
		<a style='text-decoration:none; color:#009933;' href='editinfo.php?id=$user_id'>Update</a>
		&nbsp;
		<a  style='text-decoration:none; color:red;' href='confirmdelete.php?vacidno=$db_vacidno' id='delete'>Delete</a>
