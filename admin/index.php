        ...
        <div class="container-fluid d-flex justify-content-center align-items-center align-content-center video-parallax-container">
            <div class="row">
                <div class="col-12">
                    ...
                    <p class="text-center" style="color: rgb(255,255,255);font-size: 29px;">Do you need help?&nbsp;<a class="btn btn-primary" role="button" style="background: rgb(0,153,51);font-family: Roboto, sans-serif;font-size: 23px;border-style: none;" href="regformadmin.php">REGISTER NOW!</a></p>
                </div>
            </div>
        </div>
    </div>
