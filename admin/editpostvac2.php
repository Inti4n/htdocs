...
$get_record = mysqli_query($connections, "SELECT * FROM tbl_postvac2nddose WHERE id='$user_id'");
		...
		$fb_email = $fb_message =  "";
			...
			if ($_SERVER["REQUEST_METHOD"] == "POST"){
				...
				if ($fb_email && $fb_message) {
					...
					echo "<script>window.location.href='editpostvac2.php';</script>";
				}
			}
?>
...
<body>
    ...
    <div class="container">
        <div>
            <form method="POST" action="Update_Record_Post2.php" autocomplete="on">
                <div class="form-group mb-3">
                    <div id="formdiv">
                        <div class="row" style="margin-right:0px;margin-left:0px;padding-top:24px;">
                            <div class="col">
                                <h4 style="border-color: #009933;color: rgb(254,142,23);font-size: 32px;text-align: center;"><strong>POST VACCINATION NOTES 2ND DOSE</strong><br></h4>
