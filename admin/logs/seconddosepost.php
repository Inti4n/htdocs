                    ...
                    <div id="formdiv">
                        ...
                        <div class="row" style="margin-right:0px;margin-left:0px;padding-top:24px;margin-top:-16px;">
                            ...
                            <div class="col-md-10 offset-md-1">
                                <div class="form-check"><input class="form-check-input" type="radio" id="formCheck-11"><label class="form-check-label" for="formCheck-11">Discharge and no symptoms observed</label></div>
                                <div class="form-check"><input class="form-check-input" type="radio" id="formCheck-12"><label class="form-check-label" for="formCheck-12">Symptoms was observed and managed. Discharge after resolution of symptoms</label></div>
                                <div class="form-check"><input class="form-check-input" type="radio" id="formCheck-1"><label class="form-check-label" for="formCheck-1">Referred to Hospital</label></div>
                            </div>
                        </div>
                        <div class="row" style="margin-right:0px;margin-left:0px;padding-top:24px;margin-top:-16px;">
                            <div class="col-md-8 offset-md-1" style="font-size: 20px;">
                            ...
                            <div class="col-md-10 offset-md-1"><input class="form-control" type="text" placeholder="Enter the Name" required=""></div>
                        </div>
                        <div class="row" style="margin-right:0px;margin-left:0px;padding-top:24px;">
                            <div class="col-md-8 offset-md-1">
                        ...
                        <div class="row" style="margin-right:0px;margin-left:0px;padding-top:24px;">
                            ...
                            <div class="col-12 col-md-4 offset-md-4 d-flex align-items-center align-content-center" style="width: 252.646px;height: 77px;"><a class="btn btn-light btn-lg" role="button" style="font-family: Roboto, sans-serif;background: #fe8e17;font-size: 14px;color: rgb(255,255,255);width: 95.1562px;" href="seconddetails.php">DETAILS</a><a class="btn btn-light btn-lg" role="button" style="margin-left: 16px;color: rgb(255,255,255);background: #fe8e17;font-size: 14px;width: 104.0625px;font-family: Roboto, sans-serif;" href="booster.php">BOOSTER</a></div>
                        </div>
                    </div>
                </div>
            </form>
            ...
            <table id="example" style="width:100%" class="table table-striped table-bordered">
              ...
              <tbody>
                <tr>
                  ...
                  <td>Discharge and no symptoms observed</td>
                  <td>Russel Aseron</td>
                  <td>Image</td>
                     <td><a href="updatepostvac2.php" style="text-decoration:none; color:#009933;" >Update</a></td>
                  </tr>
