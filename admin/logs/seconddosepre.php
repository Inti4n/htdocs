                ...
                <div class="form-group mb-3">
                    <div id="formdiv">
                        ...
                        <div class="row" style="margin-right:0px;margin-left:0px;padding-top:24px;margin-top:-16px;">
                            ...
                            <div class="col-md-10 offset-md-1"><input class="form-control" type="number" required="" placeholder="Enter your Temperature" style="font-family: Roboto, sans-serif;"></div>
                        </div>
                        <div class="row" style="margin-right:0px;margin-left:0px;padding-top:24px;margin-top:-16px;">
                            <div class="col-md-8 offset-md-1" style="font-size: 20px;">
                            ...
                            <div class="col-md-10 offset-md-1"><input class="form-control" type="number" required="" placeholder="Enter your Heart Rate" style="font-family: Roboto, sans-serif;"></div>
                        </div>
                        <div class="row" style="margin-right:0px;margin-left:0px;padding-top:24px;">
                            <div class="col-md-8 offset-md-1">
                            ...
                            <div class="col-md-10 offset-md-1"><input class="form-control" type="text" style="margin: 7px;margin-left: 0px;font-family: Roboto, sans-serif;" name="name" placeholder="Enter your Blood Pressure" required=""></div>
                        </div>
                        <div class="row" style="margin-right:0px;margin-left:0px;padding-top:24px;margin-top:-16px;">
                            <div class="col-md-8 offset-md-1" style="font-size: 20px;">
                        ...
                        <div class="row" style="margin-right:0px;margin-left:0px;padding-top:24px;">
                            ...
                            <div class="col-md-10 offset-md-1">
                                <div class="form-check" style="font-family: Roboto, sans-serif;"><input class="form-check-input" type="checkbox" id="formCheck-1" style="font-family: Roboto, sans-serif;"><label class="form-check-label" for="formCheck-1" style="font-family: Roboto, sans-serif;">Fever/Chills</label></div>
                            </div>
                            <div class="col-md-10 offset-md-1" style="font-family: Roboto, sans-serif;">
                                <div class="form-check" style="font-family: Roboto, sans-serif;"><input class="form-check-input" type="checkbox" id="formCheck-7" style="font-family: Roboto, sans-serif;"><label class="form-check-label" for="formCheck-7" style="font-family: Roboto, sans-serif;">Headache</label></div>
                            </div>
                            <div class="col-md-10 offset-md-1" style="font-family: Roboto, sans-serif;">
                                <div class="form-check" style="font-family: Roboto, sans-serif;"><input class="form-check-input" type="checkbox" id="formCheck-6" style="font-family: Roboto, sans-serif;"><label class="form-check-label" for="formCheck-6" style="font-family: Roboto, sans-serif;">Cough</label></div>
                            </div>
                            <div class="col-md-10 offset-md-1" style="font-family: Roboto, sans-serif;">
                                <div class="form-check" style="font-family: Roboto, sans-serif;"><input class="form-check-input" type="checkbox" id="formCheck-5" style="font-family: Roboto, sans-serif;"><label class="form-check-label" for="formCheck-5" style="font-family: Roboto, sans-serif;">Colds</label></div>
                            </div>
                            <div class="col-md-10 offset-md-1" style="font-family: Roboto, sans-serif;">
                                <div class="form-check" style="font-family: Roboto, sans-serif;"><input class="form-check-input" type="checkbox" id="formCheck-4" style="font-family: Roboto, sans-serif;"><label class="form-check-label" for="formCheck-4" style="font-family: Roboto, sans-serif;">Diarrhea</label></div>
                            </div>
                            <div class="col-md-10 offset-md-1" style="font-family: Roboto, sans-serif;">
                                <div class="form-check" style="font-family: Roboto, sans-serif;"><input class="form-check-input" type="checkbox" id="formCheck-3" style="font-family: Roboto, sans-serif;"><label class="form-check-label" for="formCheck-3" style="font-family: Roboto, sans-serif;">Loss of smell/taste</label></div>
                            </div>
                            <div class="col-md-10 offset-md-1" style="font-family: Roboto, sans-serif;">
                                <div class="form-check" style="font-family: Roboto, sans-serif;"><input class="form-check-input" type="checkbox" id="formCheck-2" style="font-family: Roboto, sans-serif;"><label class="form-check-label" for="formCheck-2" style="font-family: Roboto, sans-serif;">No Symptoms</label></div>
                            </div>
                        </div>
                        <div class="row" style="margin-right:0px;margin-left:0px;padding-top:24px;">
                            <div class="col-md-8 offset-md-1">
                            ...
                            <div class="col-md-10 offset-md-1">
                                <div class="form-check"><input class="form-check-input" type="radio" id="formCheck-8"><label class="form-check-label" for="formCheck-8">Vaccinate</label></div>
                            </div>
                            <div class="col-md-10 offset-md-1">
                                <div class="form-check"><input class="form-check-input" type="radio" id="formCheck-10"><label class="form-check-label" for="formCheck-10">Do not vaccinate</label></div>
                            </div>
                            <div class="col-md-10 offset-md-1">
                                <div class="form-check"><input class="form-check-input" type="radio" id="formCheck-9"><label class="form-check-label" for="formCheck-9">Other instructions</label></div><textarea class="form-control" placeholder="Notes"></textarea>
                            </div>
                        </div>
                        <div class="row" style="margin-right:0px;margin-left:0px;padding-top:24px;">
            ...
            <table id="example" style="width:100%" class="table table-striped table-bordered">
              ...
              <tbody>
                <tr>
                  ...
                  <td>Vaccinate</td>
                  <td>Proceed</td>
                     <td><a href="updateprevac2.php" style="text-decoration:none; color:#009933;" >Update</a></td>
                  </tr>
