...
$get_record = mysqli_query($connections, "SELECT * FROM tbl_prevac1stdose WHERE id='$user_id'");
		...
		$fb_email = $fb_message =  "";
			...
			if ($_SERVER["REQUEST_METHOD"] == "POST"){
				...
				if ($fb_email && $fb_message) {
					...
					echo "<script>window.location.href='editprevac1.php';</script>";
				}
			}
?>
...
<body>
    ...
    <div style="text-align: center;">
        <h2 style="border-color: #009933;color: #009933;"><strong>FIRST&nbsp;DOSE INFORMATION</strong></h2>
    </div>
    <div class="container">
        <div>
            <form method="POST" action="Update_Record_Pre1.php" autocomplete="on">
