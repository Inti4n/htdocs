...
$get_record = mysqli_query($connections, "SELECT * FROM tbl_vacdetails1stdose WHERE id='$user_id'");
		...
		$fb_email = $fb_message =  "";
			...
			if ($_SERVER["REQUEST_METHOD"] == "POST"){
				...
				if ($fb_email && $fb_message) {
					...
					echo "<script>window.location.href='editdetails1.php';</script>";
				}
			}
?>
...
<body>
    ...
    <div class="container">
        <div>
            <form method="POST" action="Update_Record_Details1.php" autocomplete="on" enctype="multipart/form-data">
