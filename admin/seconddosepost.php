		...
		$fb_email = $fb_message =  "";
			...
			if ($_SERVER["REQUEST_METHOD"] == "POST"){
				...
				if ($fb_email && $fb_message) {
					...
					echo "<script>window.location.href='seconddosepost.php';</script>";
				}
			}
?>
...
<body>
    ...
    <div style="text-align: center;">
        <h2 style="border-color: #009933;color: #009933;"><strong>SECOND&nbsp;DOSE INFORMATION TABLE</strong></h2>
    </div>
    <div class="container">
        <div>
            <form>
...
$sql = "SELECT * FROM tbl_postvac2nddose";
...
$view_query = mysqli_query($connections, "SELECT * FROM tbl_postvac2nddose ORDER BY id ASC ");

echo "<thead>
<tr>
	<th>Vaccination ID number</th>
	<th>Name</th>
	<th>Post Vaccination Note 2nd Dose</th>
	<th>Monitored by</th>
	<th>Option</th>
</tr>
...
while ($row = mysqli_fetch_assoc($view_query)) {
	...
	$db_name = $row["name"];
	$db_post_vacnote = $row["post_vacnote"];
	$db_monitor = $row["monitor"];
	...
	<tr>
		<td>$db_vacidno</td>
		<td>$db_name</td>
		<td>$db_post_vacnote</td>
		<td>$db_monitor</td>
		<td>
		<a href='editpostvac2.php?id=$user_id' style='text-decoration:none; color:#009933;'>Update</a>
		</td>
	</tr>
