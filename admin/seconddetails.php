...
$sql = "SELECT * FROM tbl_vacdetails2nddose";
...
$view_query = mysqli_query($connections, "SELECT * FROM tbl_vacdetails2nddose ORDER BY id ASC ");
...
while ($row = mysqli_fetch_assoc($view_query)) {
	...
	<tr>
		...
		<td>$db_filename</td>
		<td>
		<a href='editdetails2.php?id=$user_id' style='text-decoration:none; color:#009933;'>Update</a>
		</td>
	</tr>
