            ...
            <form>
                <div class="form-group mb-3">
                    <div id="formdiv">
                        ...
                        <div class="row" style="margin-right:0px;margin-left:0px;padding-top:24px;">
                           <div class="col-12 col-md-4 offset-md-4 d-flex align-items-center align-content-center" style="width: 252.646px;height: 77px;"><a class="btn btn-light btn-lg" role="button" style="font-family: Roboto, sans-serif;background: #fe8e17;font-size: 14px;color: rgb(255,255,255);width: 95.1562px;" href="firstdetails.php">DETAILS</a><a class="btn btn-light btn-lg" role="button" style="margin-left: 16px;color: rgb(255,255,255);background: #fe8e17;font-size: 14px;width: 104.0625px;" href="seconddosepre.php">2ND DOSE</a></div>
                        </div>
                    </div>
                </div>
            </form>
...
$sql = "SELECT * FROM tbl_postvac1stdose";
...
$view_query = mysqli_query($connections, "SELECT * FROM tbl_postvac1stdose ORDER BY id ASC ");

echo "<thead>
<tr>
	<th>Vaccination ID number</th>
	<th>Name</th>
	<th>Post Vaccination Note 1st Dose</th>
	<th>Monitored by</th>
	<th>Option</th>
</tr>
...
while ($row = mysqli_fetch_assoc($view_query)) {
	...
	<tr>
		...
		<td>$db_monitor</td>
		<td>
		<a href='editpostvac1.php?id=$user_id' style='text-decoration:none; color:#009933;'>Update</a>
		</td>
	</tr>
