...
$get_record = mysqli_query($connections, "SELECT * FROM tbl_prevac2nddose WHERE id='$user_id'");
...
while($row_edit = mysqli_fetch_assoc($get_record)){
			...
			$db_temperature = $row_edit["temperature"];	
			$db_heart_rate = $row_edit["heart_rate"];
			$db_blood_pressure = $row_edit["blood_pressure"];	
			$db_respiratory_rate = $row_edit["respiratory_rate"];
			$db_symptoms1 = $row_edit["symptoms"];	
			$doctor_note = $row_edit["doctor_note"];
		...
		$fb_email = $fb_message =  "";
			...
			if ($_SERVER["REQUEST_METHOD"] == "POST"){
				...
				if ($fb_email && $fb_message) {
					...
					echo "<script>window.location.href='editprevac2.php';</script>";
				}
			}
?>
...
<body>
    ...
    <div class="container">
        <div>
            <form method="POST" action="Update_Record_Pre2.php" autocomplete="on">
                <div class="form-group mb-3">
                    <div id="formdiv">
                        <div class="row" style="margin-right:0px;margin-left:0px;padding-top:24px;">
                            <div class="col">
                                <h4 style="border-color: #009933;color: rgb(254,142,23);font-size: 32px;text-align: center;"><strong>PRE-VACCINATION SCREENING NOTES 2ND DOSE</strong><br></h4>
                        ...
                        <div class="row" style="margin-right:0px;margin-left:0px;padding-top:24px;margin-top:-16px;">
                            <div class="col-md-8 offset-md-1" style="font-size: 20px;">
                                <p style="margin-left: 2%;font-family: Roboto, sans-serif;font-size: 20px;"><strong>Temperature:</strong><span style="color: var(--bs-red);">&nbsp;*</span><strong> </strong></p>
                            </div>
                            <div class="col-md-10 offset-md-1"><input class="form-control" type="number" name="new_temp1" value="<?php echo $db_temperature; ?>" step="0.01" placeholder="Enter your Temperature" style="font-family: Roboto, sans-serif;"></div>
                        </div>
                        <div class="row" style="margin-right:0px;margin-left:0px;padding-top:24px;margin-top:-16px;">
                            <div class="col-md-8 offset-md-1" style="font-size: 20px;">
                                <p style="margin-left: 2%;font-family: Roboto, sans-serif;font-size: 20px;"><strong>Heart Rate:</strong><span style="color: var(--bs-red);">&nbsp;*</span><strong> </strong></p>
                            </div>
                            <div class="col-md-10 offset-md-1"><input class="form-control" type="number" name="new_hr1" value="<?php echo $db_heart_rate; ?>"   placeholder="Enter your Heart Rate" style="font-family: Roboto, sans-serif;"></div>
                        </div>
                        <div class="row" style="margin-right:0px;margin-left:0px;padding-top:24px;">
                            <div class="col-md-8 offset-md-1">
                                <p style="margin-left: 2%;font-family: Roboto, sans-serif;font-size: 20px;"><strong>Blood Pressure:</strong><span style="color: var(--bs-red);">&nbsp;*</span></p>
                            </div>
                            <div class="col-md-10 offset-md-1"><input class="form-control" type="text" style="margin: 7px;margin-left: 0px;font-family: Roboto, sans-serif;" name="new_bp1" value="<?php echo $db_blood_pressure; ?>" placeholder="Enter your Blood Pressure" ></div>
                        </div>
                        <div class="row" style="margin-right:0px;margin-left:0px;padding-top:24px;margin-top:-16px;">
                            <div class="col-md-8 offset-md-1" style="font-size: 20px;">
                                <p style="margin-left: 2%;font-family: Roboto, sans-serif;font-size: 20px;"><strong>Respiratory Rate:</strong><span style="color: var(--bs-red);">&nbsp;*</span><strong> </strong></p>
                            </div>
                            <div class="col-md-10 offset-md-1"><input class="form-control" type="number" name="new_rr1" value="<?php echo $db_respiratory_rate; ?>" placeholder="Enter your Heart Rate" style="font-family: Roboto, sans-serif;"></div>
                        </div>
                        <div class="row" style="margin-right:0px;margin-left:0px;padding-top:24px;">
                            <div class="col-md-8 offset-md-1">
                                <p style="margin-left: 2%;font-family: Roboto, sans-serif;font-size: 16px;"><strong>What symptoms do you feel in the past few weeks?</strong><span style="color: var(--bs-red);">&nbsp;*</span></p>
                            </div>
                            <div class="col-md-10 offset-md-1">
                                <div class="form-check" style="font-family: Roboto, sans-serif;"><input class="form-check-input" type="checkbox" id="formCheck-1" style="font-family: Roboto, sans-serif;" name="new_symptoms1[]" value="Fever/Chills" <?php if(isset($_POST["db_symptoms1"]) && in_array("Fever/Chills",
						$_POST["db_symptoms1"])) echo 'checked="checked"'; ?> ><label class="form-check-label" for="formCheck-1" style="font-family: Roboto, sans-serif;">Fever/Chills</label></div>
                            </div>
                            <div class="col-md-10 offset-md-1" style="font-family: Roboto, sans-serif;">
                                <div class="form-check" style="font-family: Roboto, sans-serif;"><input class="form-check-input" type="checkbox" id="formCheck-7" style="font-family: Roboto, sans-serif;" name="new_symptoms1[]" value="Headache" <?php if(isset($_POST["db_symptoms1"]) && in_array("Headache",
						$_POST["db_symptoms1"])) echo 'checked="checked"'; ?>><label class="form-check-label" for="formCheck-7" style="font-family: Roboto, sans-serif;">Headache</label></div>
                            </div>
                            <div class="col-md-10 offset-md-1" style="font-family: Roboto, sans-serif;">
                                <div class="form-check" style="font-family: Roboto, sans-serif;"><input class="form-check-input" type="checkbox" id="formCheck-6" style="font-family: Roboto, sans-serif;" name="new_symptoms1[]" value="Cough" <?php if(isset($_POST["db_symptoms1"]) && in_array("Cough",
						$_POST["db_symptoms1"])) echo 'checked="checked"'; ?>><label class="form-check-label" for="formCheck-6" style="font-family: Roboto, sans-serif;">Cough</label></div>
                            </div>
                            <div class="col-md-10 offset-md-1" style="font-family: Roboto, sans-serif;">
                                <div class="form-check" style="font-family: Roboto, sans-serif;"><input class="form-check-input" type="checkbox" id="formCheck-5" style="font-family: Roboto, sans-serif;" name="new_symptoms1[]" value="Colds" <?php if(isset($_POST["db_symptoms1"]) && in_array("Colds",
						$_POST["db_symptoms1"])) echo 'checked="checked"'; ?>><label class="form-check-label" for="formCheck-5" style="font-family: Roboto, sans-serif;">Colds</label></div>
                            </div>
                            <div class="col-md-10 offset-md-1" style="font-family: Roboto, sans-serif;">
                                <div class="form-check" style="font-family: Roboto, sans-serif;"><input class="form-check-input" type="checkbox" id="formCheck-4" style="font-family: Roboto, sans-serif;" name="new_symptoms1[]" value="Diarrhea" <?php if(isset($_POST["db_symptoms1"]) && in_array("Diarrhea",
						$_POST["db_symptoms1"])) echo 'checked="checked"'; ?>><label class="form-check-label" for="formCheck-4" style="font-family: Roboto, sans-serif;">Diarrhea</label></div>
                            </div>
                            <div class="col-md-10 offset-md-1" style="font-family: Roboto, sans-serif;">
                                <div class="form-check" style="font-family: Roboto, sans-serif;"><input class="form-check-input" type="checkbox" id="formCheck-3" style="font-family: Roboto, sans-serif;" name="new_symptoms1[]" value="Loss of smell/taste" <?php if(isset($_POST["db_symptoms1"]) && in_array("Loss of smell/taste",
						$_POST["db_symptoms1"])) echo 'checked="checked"'; ?>><label class="form-check-label" for="formCheck-3" style="font-family: Roboto, sans-serif;">Loss of smell/taste</label></div>
                            </div>
                            <div class="col-md-10 offset-md-1" style="font-family: Roboto, sans-serif;">
                                <div class="form-check" style="font-family: Roboto, sans-serif;"><input class="form-check-input" type="checkbox" id="formCheck-2" style="font-family: Roboto, sans-serif;" name="new_symptoms1[]" value="No Symptoms" <?php if(isset($_POST["db_symptoms1"]) && in_array("No Symptoms",
						$_POST["db_symptoms1"])) echo 'checked="checked"'; ?> ><label class="form-check-label" for="formCheck-2" style="font-family: Roboto, sans-serif;">No Symptoms</label></div>
                            </div>
                        </div>
                        <div class="row" style="margin-right:0px;margin-left:0px;padding-top:24px;">
                            <div class="col-md-8 offset-md-1">
                                <p style="margin-left: 2%;font-family: Roboto, sans-serif;font-size: 20px;"><strong>Doctor's Notes:</strong></p>
                            </div>
                            <div class="col-md-10 offset-md-1">
                                <div class="form-check"><input class="form-check-input" type="radio" id="formCheck-8" name="new_dn1" <?php if (isset($doctor_note) && $doctor_note=="Vaccinate") echo "checked"; ?> value="Vaccinate"><label class="form-check-label" for="formCheck-8">Vaccinate</label></div>
                            </div>
                            <div class="col-md-10 offset-md-1">
                                <div class="form-check"><input class="form-check-input" type="radio" id="formCheck-10" name="new_dn1" <?php if (isset($doctor_note) && $doctor_note=="Do not vaccinate") echo "checked"; ?> value="Do not vaccinate"><label class="form-check-label" for="formCheck-10">Do not vaccinate</label></div>
                            </div>
                            <div class="col-md-10 offset-md-1">
                                <div class="form-check"><input class="form-check-input" type="radio" id="formCheck-9" name="new_dn1" <?php if (isset($doctor_note) && $doctor_note=="Other instructions:") echo "checked"; ?> value="Other instructions:"><label class="form-check-label" for="formCheck-9">Other instructions</label></div>
								<textarea class="form-control" name="new_note1" rows="5" cols="50" placeholder="Notes" ><?php echo $db_note;?></textarea>
                            </div>
                            <div class="col">
                                <div class="row" style="margin-right:0px;margin-left:0px;padding-top:24px;">
                                    <div class="col-12 col-md-4 offset-md-4 d-flex align-items-center align-content-center" style="width: 252.646px;height: 62px;"><button class="btn btn-light btn-lg" style="margin-left: 16px;color: rgb(255,255,255);background: #009933;" type="submit">UPDATE</button><a class="btn btn-light btn-lg" role="button" style="margin-left: 16px;color: rgb(255,255,255);background: #fe8e17;" href="seconddosepre.php">BACK</a></div>
                                </div>
                            </div>
                        </div>
                    </div>
