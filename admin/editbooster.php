...
$get_record = mysqli_query($connections, "SELECT * FROM tbl_booster WHERE id='$user_id'");
...
while($row_edit = mysqli_fetch_assoc($get_record)){
			...
			$db_booster = $row_edit["booster"];	
			$db_vac_brand = $row_edit["vac_brand"];
		...
		$fb_email = $fb_message =  "";
			...
			if ($_SERVER["REQUEST_METHOD"] == "POST"){
				...
				if ($fb_email && $fb_message) {
					...
					echo "<script>window.location.href='editbooster.php';</script>";
				}
			}
?>
...
<body>
    ...
    <div style="text-align: center;">
        <h2 style="border-color: #009933;color: #009933;"><strong>BOOSTER INFORMATION</strong></h2>
    </div>
    <div class="container">
        <div>
            <form method="POST" action="Update_Record_Booster.php" autocomplete="on">
                <div class="form-group mb-3">
                    <div id="formdiv">
                        <div class="row" style="margin-right:0px;margin-left:0px;padding-top:24px;">
                            <div class="col">
                                <h4 style="border-color: #009933;color: rgb(254,142,23);font-size: 22px;text-align: left;width: 241.281px;"><strong>BOOSTER SHOT</strong></h4>
                        ...
                        <div class="row" style="margin-right:0px;margin-left:0px;padding-top:24px;">
                            <div class="col-md-8 offset-md-1">
                                <p style="margin-left: 2%;font-family: Roboto, sans-serif;font-size: 20px;"><strong>Did you receive booster shot?</strong><span style="color: var(--bs-red);">&nbsp;*</span><br></p>
                            </div>
                            <div class="col-md-10 offset-md-1">
                                <div class="form-check"><input class="form-check-input" type="radio" id="formCheck-2" name="new_booster" <?php if (isset($db_booster) && $db_booster=="Yes") echo "checked"; ?> value="Yes" >
								<label class="form-check-label" for="formCheck-2" style="font-family: Roboto, sans-serif;">Yes</label></div>
                            </div>
                            <div class="col-md-10 offset-md-1">
                                <div class="form-check"><input class="form-check-input" type="radio" id="formCheck-3" name="new_booster" <?php if (isset($db_booster) && $db_booster=="No") echo "checked"; ?> value="No" >
								<label class="form-check-label" for="formCheck-3" style="font-family: Roboto, sans-serif;">No</label></div>
                            </div>
                        </div>
                        <div class="row" style="margin-right:0px;margin-left:0px;padding-top:24px;">
                            <div class="col-md-8 offset-md-1">
                            ...
                            <div class="col-md-10 offset-md-1"><select class="form-select" name="new_vac_brand">
                                    <optgroup label="Choose a Brand">
										 <option <?php if (isset($db_vac_brand) && $db_vac_brand=="None") echo "selected"; ?> value="None">None</option>
                                        <option <?php if (isset($db_vac_brand) && $db_vac_brand=="Pfizer-BioNTech") echo "selected"; ?> value="Pfizer-BioNTech">Pfizer-BioNTech</option>
                                        <option <?php if (isset($db_vac_brand) && $db_vac_brand=="Oxford-AstraZeneca") echo "selected"; ?> value="Oxford-AstraZeneca">Oxford-AstraZeneca</option>
                                        <option <?php if (isset($db_vac_brand) && $db_vac_brand=="Moderna") echo "selected"; ?> value="Moderna">Moderna</option>
                                        <option <?php if (isset($db_vac_brand) && $db_vac_brand=="Johnson and Johnsons Janssen") echo "selected"; ?> value="Johnson and Johnsons Janssen">Johnson and Johnson's Janssen</option>
                                        <option <?php if (isset($db_vac_brand) && $db_vac_brand=="CoronaVac-Sinovac") echo "selected"; ?> value="CoronaVac-Sinovac">CoronaVac-Sinovac</option>
                                        <option <?php if (isset($db_vac_brand) && $db_vac_brand=="Gamaleya Sputnik V") echo "selected"; ?> value="Gamaleya Sputnik V">Gamaleya Sputnik V</option>
                                        <option <?php if (isset($db_vac_brand) && $db_vac_brand=="Sinopharm") echo "selected"; ?> value="Sinopharm">Sinopharm</option>
                                        <option <?php if (isset($db_vac_brand) && $db_vac_brand=="Bharat BioTech") echo "selected"; ?> value="Bharat BioTech">Bharat BioTech</option>
                                    </optgroup>
                                </select></div>
                            <div class="col">
                                <div class="row" style="margin-right:0px;margin-left:0px;padding-top:24px;">
                                    <div class="col-12 col-md-4 offset-md-4 d-flex align-items-center align-content-center" style="width: 252.646px;height: 62px;"><button class="btn btn-light btn-lg" style="margin-left: 16px;color: rgb(255,255,255);background: #009933;" type="submit">UPDATE</button><a class="btn btn-light btn-lg" role="button" style="margin-left: 16px;color: rgb(255,255,255);background: #fe8e17;" href="booster.php">BACK</a></div>
                                </div>
                            </div>
                        </div>
                    </div>
