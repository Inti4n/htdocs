...
<?php
//For Vaccination Details 1st Dose
$user_id = $_REQUEST["id"];
...
$get_record = mysqli_query($connections, "SELECT * FROM tbl_postvac1stdose WHERE id='$user_id'");
...
while($row_edit = mysqli_fetch_assoc($get_record)){
			...
			$db_postvacnote1 = $row_edit["post_vacnote"];	
			$db_monitor1 = $row_edit["monitor"];
		...
		$fb_email = $fb_message =  "";
			...
			if ($_SERVER["REQUEST_METHOD"] == "POST"){
				...
				if ($fb_email && $fb_message) {
					...
					echo "<script>window.location.href='editpostvac1.php';</script>";
				}
			}
?>
...
<body>
    ...
    <div class="container">
        <div>
            <form method="POST" action="Update_Record_Post1.php" autocomplete="on">
                <div class="form-group mb-3">
                    <div id="formdiv">
                        <div class="row" style="margin-right:0px;margin-left:0px;padding-top:24px;">
                            <div class="col">
                                <h4 style="border-color: #009933;color: rgb(254,142,23);font-size: 32px;text-align: center;"><strong>POST VACCINATION NOTES 1ST DOSE</strong><br></h4>
                        ...
                        <div class="row" style="margin-right:0px;margin-left:0px;padding-top:24px;margin-top:-16px;">
                            <div class="col-md-8 offset-md-1" style="font-size: 20px;">
                                <p style="margin-left: 2%;font-family: Roboto, sans-serif;font-size: 20px;"><strong>NOTES:</strong><span style="color: var(--bs-red);">&nbsp;*</span><strong> </strong></p>
                            </div>
                            <div class="col-md-10 offset-md-1">
                                <div class="form-check"><input class="form-check-input" type="radio" id="formCheck-11" name="new_postvacnote1" <?php if (isset($db_postvacnote1) && $db_postvacnote1=="Discharge and no symptoms observed") echo "checked"; ?> 
				value="Discharge and no symptoms observed" >
									<label class="form-check-label" for="formCheck-11">Discharge and no symptoms observed</label></div>
                                <div class="form-check"><input class="form-check-input" type="radio" id="formCheck-12" name="new_postvacnote1" <?php if (isset($db_postvacnote1) && $db_postvacnote1=="Symptoms was observed and managed. Discharge after resolution of symptoms") echo "checked"; ?> 
				value="Symptoms was observed and managed. Discharge after resolution of symptoms">
									<label class="form-check-label" for="formCheck-12">Symptoms was observed and managed. Discharge after resolution of symptoms</label></div>
                                <div class="form-check"><input class="form-check-input" type="radio" id="formCheck-1"  name="new_postvacnote1" <?php if (isset($db_postvacnote1) && $db_postvacnote1=="Referred to Hospital") echo "checked"; ?> 
				value="Referred to Hospital">
									<label class="form-check-label" for="formCheck-1">Referred to Hospital</label></div>
                            </div>
                        </div>
                        <div class="row" style="margin-right:0px;margin-left:0px;padding-top:24px;margin-top:-16px;">
                            <div class="col-md-8 offset-md-1" style="font-size: 20px;">
                                <p style="margin-left: 2%;font-family: Roboto, sans-serif;font-size: 20px;"><strong>Monitored By:</strong><span style="color: var(--bs-red);">&nbsp;*</span><strong> </strong></p>
                            </div>
                            <div class="col-md-10 offset-md-1"><input class="form-control" type="text" name="new_monitor1" value="<?php echo $db_monitor1; ?>" placeholder="Enter the Name" ></div>
                        </div>
                        <div class="row" style="margin-right:0px;margin-left:0px;padding-top:24px;">
                            <div class="col">
                                <div class="row" style="margin-right:0px;margin-left:0px;padding-top:24px;">
                                    <div class="col-12 col-md-4 offset-md-4 d-flex align-items-center align-content-center" style="width: 252.646px;height: 62px;"><button class="btn btn-light btn-lg" style="margin-left: 16px;color: rgb(255,255,255);background: #009933;" type="submit">UPDATE</button><a class="btn btn-light btn-lg" role="button" style="margin-left: 16px;color: rgb(255,255,255);background: #fe8e17;" href="firstdosepost.php">BACK</a></div>
                                </div>
                            </div>
                        </div>
                    </div>
