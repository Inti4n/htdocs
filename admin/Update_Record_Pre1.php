...
mysqli_query($connections, "UPDATE tbl_prevac1stdose SET vacidno= '$new_vaccinee_id', name='$new_db_name', temperature='$new_temp1', heart_rate='$new_hr1', blood_pressure='$new_bp1', respiratory_rate='$new_rr1', symptoms='$new_symptoms1', doctor_note='$new_dn1', note='$new_note1' WHERE id='$user_id'" );
