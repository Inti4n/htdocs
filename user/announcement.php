...
<body>
    ...
    <div class="carousel slide" data-bs-ride="carousel" id="carousel-1" style="height: 600px;">
        <div class="carousel-inner h-100" style="width: 1105.6px;margin-left: 0px;padding: 1px;">
            <div class="carousel-item active h-100" style="padding: 1px;margin: 0px 0px 0px 0px;"><img class="w-100 d-block position-absolute h-100 fit-cover" src="assets/img/sched5.png" alt="Slide Image" style="z-index: -1;"></div>
            <div class="carousel-item h-100"><img class="w-100 d-block position-absolute h-100 fit-cover" src="assets/img/sched4.png" alt="Slide Image" style="z-index: -1;"></div>
            <div class="carousel-item h-100"><img class="w-100 d-block position-absolute h-100 fit-cover" src="assets/img/sched2.png" alt="Slide Image" style="z-index: -1;"></div>
            <div class="carousel-item h-100"><img class="w-100 d-block position-absolute h-100 fit-cover" src="assets/img/sched3.png" alt="Slide Image" style="z-index: -1;"></div>
            <div class="carousel-item h-100"><img class="w-100 d-block position-absolute h-100 fit-cover" src="assets/img/sched1.png" alt="Slide Image" style="z-index: -1;"></div>
        </div>
