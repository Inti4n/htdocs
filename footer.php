        ...
        <div class="container py-4 py-lg-5">
            <div class="row justify-content-center">
                <div class="col-sm-4 col-md-3 text-center text-lg-start d-flex flex-column item">
                    <div><img class="brimslogo" src="assets/img/brimslogo.png" style="width: 80px;height: 80px;"><span style="font-size: 25px;font-family: Roboto, sans-serif;"><strong>&nbsp;&nbsp;BRIMS</strong></span></div><span style="font-family: Roboto, sans-serif;"><i class="fas fa-phone-alt"></i>&nbsp;0912-345-6789<br></span><span style="font-family: Roboto, sans-serif;"><i class="fas fa-envelope"></i>&nbsp;brims@email.com<br></span><span style="font-family: Roboto, sans-serif;"><i class="fab fa-facebook" style="font-size: 19px;"></i>&nbsp;<a href="#" style="color: rgb(255,255,255);" target="_blank">BRIMS Facebook Page</a>&nbsp;</span>
                ...
                <div class="col-sm-4 col-md-3 text-center text-lg-start d-flex flex-column item">
                    ...
                    <ul class="list-unstyled" style="font-family: Roboto, sans-serif;">
                        ...
                        <li style="font-family: Roboto, sans-serif;"><a class="link-light" href="loginfirst.php" style="font-family: Roboto, sans-serif;">Request Form</a></li>
                        ...
                        <li style="font-family: Roboto, sans-serif;"><a class="link-light" href="login.php" style="font-family: Roboto, sans-serif;">Log In</a></li>
                    </ul>
                </div>
                <div class="col-sm-4 col-md-3 text-center text-lg-start d-flex flex-column item">
                ...
                <div class="col-lg-3 text-center text-lg-start d-flex flex-column align-items-center order-first align-items-lg-start order-lg-last item social">
                    <div class="fw-bold d-flex align-items-center mb-2"></div><img src="assets/img/bsms.png" style="width: 300px;height: 150px;text-align: left;">
                </div>
            </div>
            <hr>
            <div class="d-flex justify-content-between align-items-center pt-3">
                <p class="mb-0">©CAPSTONE PROJECT. All Rights Reserved. Designed by Mark Raskien | ETEEAP Student</p>
            </div>
        </div>
    </footer>